...
Public Sub TestAllAddresses()
    ...
    Union(ActiveWorkbook.Worksheets.[_Default]("Discards").Range("A3:A7"), _
          ActiveWorkbook.Worksheets.[_Default]("Discards").Range("A10:A11"), _
          ActiveWorkbook.Worksheets.[_Default]("Discards").Range("A13:A14")).Select
    ...
    Union(ActiveWorkbook.Worksheets.[_Default]("Needs Autocorrect").Range("A6"), _
          ActiveWorkbook.Worksheets.[_Default]("Needs Autocorrect").Range("A8")).Select
    ...
    Union(ActiveWorkbook.Worksheets.[_Default]("Addresses").Range("A3"), _
          ActiveWorkbook.Worksheets.[_Default]("Addresses").Range("A8"), _
          ActiveWorkbook.Worksheets.[_Default]("Addresses").Range("A12")).Select
